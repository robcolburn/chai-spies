...
module.exports = function (chai, _) {
  ...
  function assertWith () {
    ...
    if (always) {
      ...
      if (!passed === calls.length) {
        console.log('[chai-spies] could not always find:', args);
        console.log('[chai-spies] while looking through:', calls);
      }
      ...
      if (!passed > 0) {
        console.log('[chai-spies] could not find:', args);
        console.log('[chai-spies] while looking through:', calls);
      }
